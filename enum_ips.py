#!/usr/bin/python
#$TAGS: external enumeration ip address ips cidr block expansion formatting reporting python
#$DESC: Expands a CIDR blocked IP into newline seperated IPs in that block.
